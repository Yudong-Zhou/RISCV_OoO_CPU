...
add wave -noupdate -color Coral /CPU_tb/cpu/fu_number_out0_from_UIQ
...
add wave -noupdate -color Cyan /CPU_tb/cpu/fu_number_out1_from_UIQ
...
add wave -noupdate -color White /CPU_tb/cpu/fu_number_out2_from_UIQ
...
WaveRestoreCursors {{Cursor 1} {92525 ps} 0}
...
update
WaveRestoreZoom {19871 ps} {121317 ps}
