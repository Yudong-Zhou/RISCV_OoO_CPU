...
add wave -noupdate -color Yellow /CPU_tb/cpu/Rename_inst/sr1
add wave -noupdate -color Yellow /CPU_tb/cpu/Rename_inst/sr2
add wave -noupdate -color Yellow /CPU_tb/cpu/Rename_inst/dr
...
add wave -noupdate -color Yellow /CPU_tb/cpu/Rename_inst/sr1_p
add wave -noupdate -color Yellow /CPU_tb/cpu/Rename_inst/sr2_p
add wave -noupdate -color Yellow /CPU_tb/cpu/Rename_inst/dr_p
...
WaveRestoreCursors {{Cursor 1} {85765 ps} 0}
...
update
WaveRestoreZoom {53959 ps} {165575 ps}
